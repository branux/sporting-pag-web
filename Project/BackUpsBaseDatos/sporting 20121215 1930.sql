...
INSERT INTO `imagen` (`id`,`pathBig`,`pathSmall`,`portada`,`pathMedium`) VALUES 
 (1,'../Images/noticias/noticia1.jpg','../Images/noticias/noticia1.jpg',1,''),
 (2,'../Images/noticias/noticia2.jpg','../Images/noticias/noticia2.jpg',1,''),
 (3,'../Images/noticias/lateral1.jpg','../Images/noticias/lateral1.jpg',1,'../Images/noticias/lateral1.jpg'),
 (4,'../Images/noticias/lateral2.jpg','../Images/noticias/lateral2.jpg',1,'../Images/noticias/lateral2.jpg');
...
CREATE TABLE `noticia` (
  ...
  `principal1` bit(1) NOT NULL default b'0',
  `principal2` bit(1) NOT NULL default b'0',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
INSERT INTO `noticia` (`id`,`titulo`,`descripcion`,`principal1`,`principal2`) VALUES 
 (1,'Sporting estrena web','Sporting tiene su nueva web, pasa a conocerla, tenemos todas las secciones que vos queres.',0x00,0x01),
 (2,'Nueva Noticia en Sporting','Una tendinitis no le permitió cerrar el año de la mejor manera al uruguayense Elnes Bolling Jr que jugó apenas 4 minutos en la derrota de su equipo en el clásico de San Luis por el Torneo Federal. Todo lo contrario para Facu Mendoza que con Estudiantes de Olavarría sigue ganando y anotando puntos.',0x01,0x00),
 (3,'Noticia lateral 1','Vamos que sale la primera noticia lateral del dia.',0x00,0x00),
 (4,'Noticia lateral 2','Vamos que sale la segunda noticia lateral del dia.',0x00,0x00);
