...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHBody_consola" runat="server">
    <input id="currentPage" type="hidden" runat="Server"/>
        <div style="padding:10px">
            ...
            <table style="border-right: 1px solid #C0C0C0; border-bottom: 1px solid #C0C0C0; padding: 1px 4px; width: 100%; border-left-style: solid; border-left-width: 1px; border-top-style: solid; border-top-width: 1px;">
                <tr>
                    <td>
                        <p><asp:Label ID="lblTitulo" runat="server" ForeColor="#C0C0C0" Text="Título" Width="100px"></asp:Label></p>
                        <asp:TextBox ID="txtTitulo" CssClass="text" runat="server" Width="75%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqValidTitulo" runat="server" 
                            ControlToValidate="txtTitulo" Display="Dynamic" 
                            ErrorMessage="Campo obligatorio"></asp:RequiredFieldValidator>
                        <asp:TextBox ID="txtIdNoticia" CssClass="text" runat="server" Visible="False" Width="10px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p><asp:Label ID="lblDesc" runat="server" ForeColor="#C0C0C0" Text="Descripción" Width="100px"></asp:Label></p>
                        <asp:TextBox ID="txtDesc" CssClass="text" runat="server" Width="99%" Height="120px" TextMode="MultiLine"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        <p style="padding-top:10px">
                            <asp:Label ID="lblImagenes" runat="server" ForeColor="#C0C0C0" Text="Imágenes cargadas" Width="200px"></asp:Label>
                        </p>
                        <!--Grilla imagenes-->
